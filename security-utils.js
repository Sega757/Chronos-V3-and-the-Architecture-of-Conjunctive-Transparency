...
function safeResolvePath(baseDir, relativePath) {
  ...
  const absoluteTarget = path.resolve(baseDir, normalizedRelativePath);
 ...
 * and optionally validates the host against an array of allowed hosts/domains.
 *
 ...
 */
function safeParseUrl(urlString, allowedHosts = null) {
