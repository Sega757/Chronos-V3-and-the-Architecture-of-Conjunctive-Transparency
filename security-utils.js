...
// Thread-safe single-item cache for baseDir path resolution optimization.
// Minimizes costly path.resolve() calls and string manipulations when the base directory
// remains unchanged across repeated lookups.
...
function safeResolvePath(baseDir, relativePath) {
  ...
  // Optimization: Single-item cache for baseDir path.resolve and prefix resolution
